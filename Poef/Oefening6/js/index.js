...
// console.log(leeftijd);
 ...
 //var getal1 = parseInt(window.prompt("Geef jaartal1"));
 //var getal2 = parseFloat(window.prompt("Geef jaartal2"));
// if (getal1 > getal2){
...
// var kilometers = parseFloat(window.prompt("Geef je kilometers in:"));
// console.log(`U hebt ${kilometers*1000} meters afgelegd.`)

// var aantalJaar = parseFloat(window.prompt("Geef aantal jaren"));
// alert(` ${aantalJaar} jaar is ${aantalJaar*12} maanden.`)

var zijde = parseFloat(window.prompt("Geef mij een zijde:"));
alert(`U volume is ${zijde**3}`)